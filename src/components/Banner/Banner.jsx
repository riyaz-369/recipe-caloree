        ...
        <div>
            <div className="hero min-h-[600px] min-w-screen rounded-3xl mt-12" style={{ backgroundImage: `url(${banner})` }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="mt-4">
                        <h1 className="mb-8 text-5xl font-bold">Discover an exceptional cooking <br /> class tailored for you!</h1>
                        ...
                        <div className='flex justify-center gap-8'>
                            <button
                                className="btn btn-success bg-green-500 rounded-full text-black font-semibold text-lg border-none">Explore Now
                            </button>
                            <button
